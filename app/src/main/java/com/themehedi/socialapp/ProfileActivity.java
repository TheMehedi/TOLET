...
public class ProfileActivity extends AppCompatActivity {
    ...
    private String currentUserID, PostKey, CategoryKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CategoryKey = getIntent().getExtras().get("CategoryKey").toString();
        PostRef = FirebaseDatabase.getInstance().getReference().child("Posts").child(CategoryKey).child(PostKey);
